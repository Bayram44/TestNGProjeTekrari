...
public class Day15_Tekrar01 extends TestBase {
    ...
    public void dosyaVarMi(){
        ...
        String dosyaYolu=kullaniciDosyaYolu +"/pom.xml";
    ...
    public void dosyaUpload() { // bilgisayardan websayfasına doysa yükleme
        ...
        dosyaSecmeButonu.sendKeys("C:\\Users\\Bayram\\Desktop\\logo.png");
    ...
    public void dosyaDownoad(){
        ...
        boolean varMi=Files.exists(Paths.get("C:\\Users\\Bayram\\Downloads\\Amsterdam.jpg"));
        Assert.assertTrue(varMi);
